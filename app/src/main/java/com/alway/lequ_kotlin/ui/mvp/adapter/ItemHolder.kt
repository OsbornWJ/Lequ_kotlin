...
fun createMyViewHolder(viewGroup: ViewGroup, viewType: Int): RecyclerView.ViewHolder? {
    when (viewType) {
        MulitTypeAdapter.ITEM_TYPE.ITEM_TEXTCARD.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_BRIEFCARD.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_DYNAMIC_INFOCARD.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_HORICONTAL_SCROLLCARD.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_FOLLOWCARD.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_VIDEOSMALLCARD.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_SQUARECARD_COLLECTION.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_VIDEOCOLLECTION_WITHBRIEF.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_VIDEO.type.hashCode() -> {
            val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.followcard_item, viewGroup, false)
            return ItemVideoItemHolder(view)
        }
        MulitTypeAdapter.ITEM_TYPE.ITEM_VIDEOCOLLECTION_OFHORISCROLLCARD.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_TEXTHEADER.type.hashCode() -> {
        ...
        MulitTypeAdapter.ITEM_TYPE.ITEM_TEXTFOOTER.type.hashCode() -> {
...
class ItemTextCardItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    var iv_more_header: IconTextView? = itemView.iv_more_header
    var iv_more: IconTextView? = itemView.iv_more
}
...
class ItemSquareCardCollectionHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    var iv_squarecard_more: IconTextView? = itemView.iv_squarecard_more
...
class ItemVideoCollectionOfHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    var iv_videocollection_of_header: IconTextView? = itemView.iv_videocollection_of_header
...
class ItemTextHeaderItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    var iv_text_header_more: IconTextView? = itemView.iv_text_header_more
}
...
class ItemTextFooterItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    var iv_footer_more: IconTextView? = itemView.iv_footer_more
}
